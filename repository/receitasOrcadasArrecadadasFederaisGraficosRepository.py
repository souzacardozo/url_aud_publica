...
from model.receitasOrcadasArrecadadasFederaisGraficos import ReceitasOrcadasArrecadadasFederaisGraficos

class ReceitasOrcadasArrecadadasFederaisGraficosRepository:
    def __init__(self):
        self.conexao = ConexaoClickhouse()
        
    def obter_receitasOrcadasArrecadadasFederaisGraficos(self, entidades, idquadrimestres, ano): 
    ...
    # Join the values in each list separately
        ...
        # Process the results
        receitas = [ReceitasOrcadasArrecadadasFederaisGraficos(r[0], r[1], r[2]) for r in resultado]
